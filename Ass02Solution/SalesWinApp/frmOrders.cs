...
public partial class frmOrders : Form {
    ...
    private void FilterMember() {
        ...
        List<TblOrder> filterList = new List<TblOrder>();
        // var members = memberRepository.GetMembers();
        try {
            filterList = orderRepository.GetOrderByOrderDate(DateTime.Parse(txtFromNum.Text), DateTime.Parse(txtToNum.Text));
